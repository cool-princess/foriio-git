...
@section('content')
    <section id="admin_register" class="top">
        ...
        <div class="container">
            <div class="main-title admin-register-input-title active">foriio Benefits管理者登録</div>
            <div class="main-title admin-register-confirm-title">登録内容の確認</div>
            <div class="main-title admin-register-thanks-title"><img src="{{ asset('img/register-thanks.png') }}" alt=""><span>登録完了</span></div>
            <div class="admin-register-part">
                <form id="register-form">
                    ...
                    <p class="admin-register-text">こちらからforiio Benefitsの管理者登録をお願いいたします。<br>
                ...
                <div class="admin-register-success-text">
                    foriio Benefitsへのご登録ありがとうございます。
                </div>
            </div>
        </div>
        <div class="footer">
